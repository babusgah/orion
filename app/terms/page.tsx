...
import { ShieldAlert, Power, UserX, Shield, Ban, MessageSquareWarning, Users, Lock, XCircle, AlertTriangle, ArrowLeft } from 'lucide-react'
...
export default function Terms() {
  const terms = [
    ...
    },
    {
      ...
      title: "No Backdoors",
      description: "Never insert backdoors into our games."
    },
    {
